...
function renderTable(flex, filteredData) {
    ...
    const body = [
      ...
      // substitute row data with "soft refreshed" ones
...
export function print(grid, filteredData) {
    ...
    const content = [
      ...
      // send "soft refreshed" data to renderTable() method
 ...
 * @param col - column
 * @param flare - custom painting flag
 */
